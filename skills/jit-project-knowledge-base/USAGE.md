# 使用说明：`jit-project-knowledge-base` Skill
...
1. **个人私域 Skill**：`~/.cursor/skills/jit-project-knowledge-base/`（**推荐，一次安装全项目可用**）
   - Windows 完整路径：`C:\Users\你的用户名\.cursor\skills\project-knowledge-base\`
   - macOS/Linux 完整路径：`~/.cursor/skills/jit-project-knowledge-base/`
2. **项目私域 Skill**：`.cursor/skills/jit-project-knowledge-base/`（仅当前项目可用）
...
2. **保存到固定位置**（方便重复使用）：  
   ...
   - macOS/Linux: `~/.claude/skills/jit-project-knowledge-base/`  
   使用时：`请读取 ~/.claude/skills/jit-project-knowledge-base/SKILL.md，然后分析当前项目`
