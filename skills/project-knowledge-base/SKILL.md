...
description: Analyze an existing codebase and produce PROJECT_KNOWLEDGE_BASE.md with architecture overview, module dictionary, full Util/Helper index, reusable assets, and refactoring suggestions. Use when onboarding historical projects or building internal project knowledge bases.
---
